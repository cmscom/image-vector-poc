"""SigLIP 2-based image and text embedder."""
...
class SigLIP2Embedder:
    """SigLIP 2-based multimodal embedder for images and text.

    This embedder uses Google's SigLIP 2 model to generate embeddings
    for both images and text, enabling cross-modal similarity search.

    SigLIP 2 improvements over SigLIP:
    - Gemma BPE tokenizer (256K vocab) with proper byte_fallback for CJK
    - Extended training objectives (decoder, self-distillation, masked prediction)
    - Better multilingual support (109 languages via WebLI)
    ...
    def __init__(
        ...
        """Initialize the SigLIP 2 embedder.
    ...
    def embed_texts(self, texts: list[str]) -> NDArray[np.float32]:
        ...
        Note: Uses padding="max_length" as required by SigLIP 2.
