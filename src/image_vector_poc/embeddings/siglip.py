...
class SigLIPEmbedder:
    """SigLIP-based multimodal embedder for images and text.

    This embedder uses Google's SigLIP model to generate embeddings
    ...
    def __init__(
        ...
        """Initialize the SigLIP embedder.
    ...
    def embed_texts(self, texts: list[str]) -> NDArray[np.float32]:
        ...
        Note: Uses padding="max_length" as required by SigLIP.
