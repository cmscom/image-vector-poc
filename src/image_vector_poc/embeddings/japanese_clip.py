"""Japanese CLIP embedder (Rinna model)."""
...
class JapaneseCLIPEmbedder:
    """Rinna Japanese CLIP multimodal embedder for images and text.

    This embedder uses Rinna's Japanese CLIP model to generate embeddings
    for both images and Japanese text.

    Example:
        >>> embedder = JapaneseCLIPEmbedder(device="cuda")
        >>> image = Image.open("photo.jpg")
        >>> image_emb = embedder.embed_image(image)
        >>> text_emb = embedder.embed_text("猫の写真")
    ...
    def __init__(
        ...
        """Initialize the Japanese CLIP embedder.

        Args:
            model_name: HuggingFace model identifier for Japanese CLIP.
    ...
    def embedding_dim(self) -> int:
        ...
        # Rinna's Japanese CLIP has 512-dimensional embeddings
        return 512
    ...
    def embed_text(self, text: str) -> NDArray[np.float32]:
        ...
        Args:
            text: Text string to embed (supports Japanese).
    ...
    def embed_texts(self, texts: list[str]) -> NDArray[np.float32]:
        ...
        Args:
            texts: List of text strings to embed (supports Japanese).
